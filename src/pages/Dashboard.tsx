...
function KpiCard({ label, value, icon, iconGradient, iconShadow, accentColor, trend, trendUp, accent, onClick }: KpiCardProps) {
  return (
    <div
      onClick={onClick}
      ...
      onMouseEnter={e => {
        (e.currentTarget as HTMLDivElement).style.boxShadow = '0 4px 6px -1px rgba(0,0,0,0.07), 0 20px 40px -8px rgba(0,0,0,0.10)';
        (e.currentTarget as HTMLDivElement).style.transform = 'translateY(-3px) scale(1.01)';
      }}
      onMouseLeave={e => {
        (e.currentTarget as HTMLDivElement).style.boxShadow = '0 1px 3px rgba(0,0,0,0.07), 0 8px 24px rgba(0,0,0,0.04)';
              ...
              <ResponsiveContainer width="100%" height={224}>
                <BarChart data={chartData} margin={{ left: -10, right: 4, top: 6, bottom: 0 }}>
                  ...
                  <Tooltip
                    ...
                    cursor={{ fill: 'rgba(99,102,241,0.06)', radius: 8 } as object}
                  />
