...
function BreachDot({ cx = 0, cy = 0, value = 0, threshold }: BreachDotProps) {
               ...
               chartData.length === 0 ? (
                ...
                <ResponsiveContainer width="100%" height={220}>
                  <AreaChart data={chartData} margin={{ left: -15, right: 8, top: 4 }}>
                    ...
                    <Tooltip
                      content={(props) => <ChartTooltip {...props as { active?: boolean; payload?: { value: number }[]; label?: string }} unit="mm/s" />}
                    />
                    {rmsMax && (
                      <ReferenceLine
                        y={rmsMax}
               ...
               chartData.length === 0 ? (
                ...
                <ResponsiveContainer width="100%" height={220}>
                  <AreaChart data={chartData} margin={{ left: -15, right: 8, top: 4 }}>
                    ...
                    <YAxis tick={{ fontSize: 11, fill: '#94a3b8' }} axisLine={false} tickLine={false} domain={['auto', 'auto']} />
                    <Tooltip
                      content={(props) => <ChartTooltip {...props as { active?: boolean; payload?: { value: number }[]; label?: string }} unit="°C" />}
                    />
                    {tempMax && (
                      <ReferenceLine
                        y={tempMax}
