...
import {
  ...
  Ticket, Radio, SlidersHorizontal, Zap, LogOut, ChevronLeft, Users as UsersIcon,
} from 'lucide-react';
...
function NavSection({ items, label, canWrite }) {
  ...
  return (
    ...
    >
      ...
      <nav className="flex-1 overflow-y-auto px-3 pt-6">
        ...
        {isAdmin && <NavSection items={adminNav} label="Admin" />}
      </nav>
